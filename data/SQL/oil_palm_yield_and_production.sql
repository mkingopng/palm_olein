CREATE TABLE IF NOT EXISTS public.oil_palm_yield_and_production
(
    ...
    year_code character varying COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS public.oil_palm_yield_and_production
    OWNER to postgres;